 ...
 * }; template<typename K, typename V, typename GK, typename Comparator, typename Alloc> class
 * TreeHashTable : public HashTableBase <K, V, GK, Tree<K, V, GK, Comparator, Alloc>, Alloc> { ...
...
/**
 * \brief Hash table implemented by separate-list method but the list is avltree instead of
 * linked-list
 *
